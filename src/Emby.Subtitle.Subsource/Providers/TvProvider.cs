...
namespace Emby.Subtitle.SubSource.Providers
{
    public class TvProvider
    {
        ...
        public TvProvider(IHttpClient httpClient, ILogger logger, IApplicationHost appHost,
            ...
            int season, int episode, CancellationToken cancellationToken)
        {
            ...
            var html = await SearchSubSourceTvShow(info, season, lang, cancellationToken);
        ...
        private async Task<string> SearchSubSourceTvShow(TvInformation info, int season, string lang,
